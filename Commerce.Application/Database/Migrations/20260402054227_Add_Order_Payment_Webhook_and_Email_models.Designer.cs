...
namespace Commerce.Application.Database.Migrations
{
    ...
    [Migration("20260402054227_Add_Order_Payment_Webhook_and_Email_models")]
    partial class Add_Order_Payment_Webhook_and_Email_models
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Commerce.Application.Models.EmailNotification", b =>
                {
                    ...
                    b.Property<Dictionary<string, string>>("TemplateData")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("EmailNotifications", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_EmailNotification_Status", "\"Status\" IN ('PENDING','SENT','FAILED','PERMANENTLY_FAILED')");
                        });
                });
