...
namespace Commerce.Application.Database.Migrations
{
    ...
    [Migration("20260402074119_update_OrderState")]
    partial class update_OrderState
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("EmailNotifications", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_EmailNotification_Status", "\"Status\" IN ('Queued','Sent','Failed','PermanentlyFailed')");
                        });
                });
