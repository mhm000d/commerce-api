...
public static class ApiEndpoints
{
    ...
    public static class Admin
    {
        ...
        public const string GetOrder = $"{ApiBase}/admin/orders/{{id:guid}}";
    ...
    public static class Orders
    {
        ...
        public const string Checkout = $"{ApiBase}/checkout";
        ...
        public const string RetryPayment = $"{Base}/{{id}}/retry-payment";
    }
